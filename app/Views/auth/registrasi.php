        ...
        <div class="col-lg-6 mx-auto">
            <form action="<?= base_url('registrasi/simpan-registrasi') ?>" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text"
                            class="form-control <?php if ($validation->hasError('name')) echo 'is-invalid'?>" id="name"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="email"
                            class="form-control <?php if($validation->hasError('email')) echo 'is-invalid'?>" id="email"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="password"
                            ...
                            id="email" name="password" value="<?= old('password')?>">
                        <div class="invalid-feedback">
